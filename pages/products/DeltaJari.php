    ...
    <div class="container mt-5">
        <div class="row align-items-center">
            ...
            <div class="carousel-item active">
                <img src="../productimg/DeltaJari1.jpg" class="d-block w-100" alt="DeltaJari View 1">
            </div>
            <div class="carousel-item">
                <img src="../productimg/DeltaJari2.jpg" class="d-block w-100" alt="DeltaJari View 2">
            </div>
                    </div>
            ...
            <div class="col-md-6">
                <h1 class="product-title">DeltaJari</h1>
                ...
                <div class="spec-item">
                    ...
                    <div class="spec-item">
                        ...
                        <span class="spec-value">15 Colours</span>
                    </div>
                    <div class="spec-item">
