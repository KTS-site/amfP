...
<head>
    ...
    <title>Diamond Crep Fabric</title>
    ...
    <div class="container mt-5">
        <div class="row align-items-center">
            ...
            <div class="carousel-item active">
                <img src="../productimg/DiamondCrap1.jpg" class="d-block w-100" alt="DiamondCrap View 1">
            </div>
            <div class="carousel-item">
                <img src="../productimg/DiamondCrap2.jpg" class="d-block w-100" alt="DiamondCrap View 2">
            </div>
            <div class="carousel-item">
                <img src="../productimg/DiamondCrap3.jpg" class="d-block w-100" alt="DiamondCrap View 3">
            </div>
            <div class="carousel-item">
                <img src="../productimg/DiamondCrap4.jpg" class="d-block w-100" alt="DiamondCrap View 4">
            </div>
            <div class="carousel-item">
                <img src="../productimg/DiamondCrap5.jpg" class="d-block w-100" alt="DiamondCrap View 5">
            </div>
            <div class="carousel-item">
                <img src="../productimg/DiamondCrap6.jpg" class="d-block w-100" alt="DiamondCrap View 6">
            </div>
            <div class="carousel-item">
                <img src="../productimg/DiamondCrap7.jpg" class="d-block w-100" alt="DiamondCrap View 7">
            </div>
            <div class="carousel-item">
                <img src="../productimg/DiamondCrap8.jpg" class="d-block w-100" alt="DiamondCrap View 8">
            </div>
                    </div>
            ...
            <div class="col-md-6">
                <h1 class="product-title">DiamondCrap</h1>
                <div class="specs-container">
                <div class="spec-item">
                        <span class="spec-label">Based on</span>
                        <span class="spec-value">Gergote Fabric</span>
                    </div>
                    <div class="spec-item">
                        <span class="spec-label">Colour Chart</span>
                        <span class="spec-value">110 Colours</span>
                    </div>
                    <div class="spec-item">
