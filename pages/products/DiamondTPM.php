...
<head>
    ...
    <title>Diamond TPM Fabric</title>
    ...
    <div class="container mt-5">
        <div class="row align-items-center">
            ...
            <div class="carousel-item active">
                <img src="../productimg/DiamondTPM1.jpg" class="d-block w-100" alt="DiamondTPM View 1">
            </div>
            <div class="carousel-item">
                <img src="../productimg/DiamondTPM2.jpg" class="d-block w-100" alt="DiamondTPM View 2">
            </div>
            <div class="carousel-item">
                <img src="../productimg/DiamondTPM3.jpg" class="d-block w-100" alt="DiamondTPM View 3">
            </div>
            <div class="carousel-item">
                <img src="../productimg/DiamondTPM4.jpg" class="d-block w-100" alt="DiamondTPM View 4">
            </div>
                    </div>
            ...
            <div class="col-md-6">
                <h1 class="product-title">Diamond TPM Heavy</h1>
                ...
                <div class="spec-item">
                    ...
                    <div class="spec-item">
                        ...
                        <span class="spec-value">56 Colours</span>
                    </div>
                    <div class="spec-item">
