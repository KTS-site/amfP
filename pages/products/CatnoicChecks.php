...
<head>
    ...
    <title>Catnoic Checks Fabric</title>
    ...
    <div class="container mt-5">
        <div class="row align-items-center">
            ...
            <div class="carousel-item active">
                <img src="../productimg/CatnoicChecks1.jpg" class="d-block w-100" alt="CatnoicChecks View 1">
            </div>
                    </div>
            ...
            <div class="col-md-6">
                <h1 class="product-title">Catnoic Checks</h1>
