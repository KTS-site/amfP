    ...
    <div class="container mt-5">
        <div class="row align-items-center">
            ...
            <div class="carousel-item active">
                <img src="../productimg/RabbitFurDark1.jpg" class="d-block w-100" alt="RabbitFur View 1">
            </div>
            <div class="carousel-item">
                <img src="../productimg/RabbitFurLight1.jpg" class="d-block w-100" alt="RabbitFur View 2">
            </div>
            <div class="carousel-item">
                <img src="../productimg/RabbitFur2.jpg" class="d-block w-100" alt="RabbitFur View 3">
            </div>
                    </div>
            ...
            <div class="col-md-6">
                <h1 class="product-title">Rabbit Fur</h1>
