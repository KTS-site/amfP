...
<div class="container mt-5">
        <div class="row align-items-center">
            ...
            <div class="carousel-item active">
                <img src="../productimg/Current2.jpg" class="d-block w-100" alt="Current2">
            </div>
            <div class="carousel-item">
                <img src="../productimg/Current3.jpg" class="d-block w-100" alt="Current3">
            </div>
                    </div>
            ...
            <div class="col-md-6">
                <h1 class="product-title">Current</h1>
