    ...
    <div class="container mt-5">
        <div class="row align-items-center">
            ...
            <div class="carousel-item active">
                <img src="../productimg/GorilaFur1.jpg" class="d-block w-100" alt="GorilaFur View 1">
            </div>
            <div class="carousel-item">
                <img src="../productimg/GorilaFur2.jpg" class="d-block w-100" alt="GorilaFur View 2">
            </div>
                    </div>
            ...
            <div class="col-md-6">
                <h1 class="product-title">Gorila Fur</h1>
        ...
        <div class="row">
            <div class="col-md-4 mb-4">
                <img src="../productimg/Sample/GorillaFur.png" class="img-fluid sample-image" alt="Sample Product 1">
            </div>
        </div>
    </div>
