...
<body>
    <div class="container mt-5">
        <div class="row align-items-center">
                ...
                <div id="productCarousel" class="carousel slide product-carousel" data-ride="carousel" data-interval="3000">
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="../productimg/GolmalBig2.jpg" class="d-block w-100" alt="GolmalBig View 2">
                        </div>
                        <div class="carousel-item">
                            <img src="../productimg/GolmalBig3.jpg" class="d-block w-100" alt="GolmalBig View 3">
                        </div>
                    </div>
            ...
            <div class="col-md-6">
                <h1 class="product-title">Golmal Big</h1>
