    ...
    <div class="container mt-5">
        <div class="row align-items-center">
            ...
            <div class="carousel-item active">
                <img src="../productimg/Crown1.jpg" class="d-block w-100" alt="Crown View 1">
            </div>
            <div class="carousel-item">
                <img src="../productimg/Crown2.jpg" class="d-block w-100" alt="Crown View 2">
            </div>
            <div class="carousel-item">
                <img src="../productimg/Crown3.jpg" class="d-block w-100" alt="Crown View 3">
            </div>
            <div class="carousel-item">
                <img src="../productimg/Crown4.jpg" class="d-block w-100" alt="Crown View 4">
            </div>
                    </div>
            ...
            <div class="col-md-6">
                <h1 class="product-title">Crown</h1>
                ...
                <div class="spec-item">
                    ...
                    <div class="spec-item">
                        ...
                        <span class="spec-value">11 Colours</span>
                    </div>
                    <div class="spec-item">
