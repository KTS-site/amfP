    ...
    <div class="container mt-5">
        <div class="row align-items-center">
            ...
            <div class="carousel-item active">
                <img src="../productimg/TOKO1.jpg" class="d-block w-100" alt="TOKO View 1">
            </div>
            <div class="carousel-item">
                <img src="../productimg/TOKO2.jpg" class="d-block w-100" alt="TOKO View 2">
            </div>
                    </div>
            ...
            <div class="col-md-6">
                <h1 class="product-title">TOKO</h1>
                ...
                <div class="spec-item">
                    ...
                    <div class="spec-item">
                        ...
                        <span class="spec-value">16 Colours</span>
                    </div>
                    <div class="spec-item">
