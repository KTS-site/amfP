    ...
    <div class="container mt-5">
        <div class="row align-items-center">
            ...
            <div class="carousel-item active">
                <img src="../productimg/Matrix1.jpg" class="d-block w-100" alt="Matrix View 1">
            </div>
            <div class="carousel-item">
                <img src="../productimg/Matrix2.jpg" class="d-block w-100" alt="Matrix View 2">
            </div>
                    </div>
            ...
            <div class="col-md-6">
                <h1 class="product-title">Matrix</h1>
