...
<head>
    ...
    <title>Rabit Catnoic Fabric</title>
    ...
    <div class="container mt-5">
        <div class="row align-items-center">
            ...
            <div class="carousel-item active">
                <img src="../productimg/RabitCatnoic1.jpg" class="d-block w-100" alt="Rabit Catnoic View 1">
            </div>
                    </div>
            ...
            <div class="col-md-6">
                <h1 class="product-title">Rabit Catnoic Fur</h1>
