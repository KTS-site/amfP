...
<head>
    ...
    <title>Rubbey Checks Fabric</title>
    ...
    <div class="container mt-5">
        <div class="row align-items-center">
            ...
            <div class="carousel-item active">
                <img src="../productimg/RubbeyChecks1.jpg" class="d-block w-100" alt="RubbeyChecks View 1">
            </div>
            <div class="carousel-item">
                <img src="../productimg/RubbeyChecks2.jpg" class="d-block w-100" alt="RubbeyChecks View 2">
            </div>
                    </div>
            ...
            <div class="col-md-6">
                <h1 class="product-title">RubbeyChecks</h1>
