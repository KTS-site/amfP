...
<body>
    <div class="container mt-5">
        <div class="row align-items-center">
                ...
                <div id="productCarousel" class="carousel slide product-carousel" data-ride="carousel" data-interval="3000">
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="../productimg/Azoba1.jpg" class="d-block w-100" alt="Azoba View 1">
                        </div>
                    </div>
            ...
            <div class="col-md-6">
                <h1 class="product-title">Azoba</h1>
                <div class="specs-container">
                    ...
                    <div class="spec-item">
                        ...
                        <span class="spec-value">6 Colours</span>
                    </div>
                    <div class="spec-item">
