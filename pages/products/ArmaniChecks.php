...
<head>
    ...
    <title>Armani Checks Fabric</title>
    ...
    <div class="container mt-5">
        <div class="row align-items-center">
            ...
            <div class="carousel-item active">
                <img src="../productimg/ArmaniChecks1.jpg" class="d-block w-100" alt="ArmaniChecks View 1">
            </div>
            <div class="carousel-item">
                <img src="../productimg/ArmaniChecks2.jpg" class="d-block w-100" alt="ArmaniChecks View 2">
            </div>
            <div class="carousel-item">
                <img src="../productimg/ArmaniChecks3.jpg" class="d-block w-100" alt="ArmaniChecks View 3">
            </div>
                    </div>
            ...
            <div class="col-md-6">
                <h1 class="product-title">Armani Checks</h1>
                ...
                <div class="spec-item">
                    ...
                    <div class="spec-item">
                        ...
                        <span class="spec-value">12 Colours</span>
                    </div>
                    <div class="spec-item">
