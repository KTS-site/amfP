...
<head>
    ...
    <title>Sugarcane Lycra Fabric</title>
...
<body>
    <div class="container mt-5">
        <div class="row align-items-center">
                ...
                <div id="productCarousel" class="carousel slide product-carousel" data-ride="carousel" data-interval="3000">
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="../productimg/SUGARCANE3.jpg" class="d-block w-100" alt="Sugarcane Lycra Fabric View 1">
                        </div>
                        <div class="carousel-item">
                            <img src="../productimg/SUGARCANE2.jpg" class="d-block w-100" alt="Sugarcane Lycra Fabric View 2">
                        </div>
                        <div class="carousel-item">
                            <img src="../productimg/SUGARCANE1.jpg" class="d-block w-100" alt="Sugarcane Lycra Fabric View 3">
                        </div>
                    </div>
            ...
            <!-- Product Specifications with animation -->
            <div class="col-md-6">
                <h1 class="product-title">Airport</h1>
                <div class="specs-container">
                    ...
                    <div class="spec-item">
                        ...
                        <span class="spec-value">Shirts, T-shirts, Kurtis, Kurtas, and Co-Ord Sets for Babies</span>
                    </div>
                </div>
            </div>
        </div>

        <!-- Segment Title and Sample Product Images with animation -->
