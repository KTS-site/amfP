...
<body>
    <div class="container mt-5">
        <div class="row align-items-center">
                ...
                <div id="productCarousel" class="carousel slide product-carousel" data-ride="carousel" data-interval="3000">
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="../productimg/KorasBig1.jpg" class="d-block w-100" alt="KorasBig View 1">
                        </div>
                        <div class="carousel-item">
                            <img src="../productimg/KorasBig2.jpg" class="d-block w-100" alt="KorasBig View 2">
                        </div>
                    </div>
            ...
            <div class="col-md-6">
                <h1 class="product-title">KorasBig</h1>
