...
<head>
    ...
    <title>Jigana Checks Fabric</title>
    ...
    <div class="container mt-5">
        <div class="row align-items-center">
            ...
            <div class="carousel-item active">
                <img src="../productimg/JiganaChecks1.jpg" class="d-block w-100" alt="JiganaChecks View 1">
            </div>
            <div class="carousel-item">
                <img src="../productimg/JiganaChecks2.jpg" class="d-block w-100" alt="JiganaChecks View 2">
            </div>
            <div class="carousel-item">
                <img src="../productimg/JiganaChecks3.jpg" class="d-block w-100" alt="JiganaChecks View 3">
            </div>
                    </div>
            ...
            <div class="col-md-6">
                <h1 class="product-title">Jigana Checks</h1>
