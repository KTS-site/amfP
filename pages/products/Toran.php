    ...
    <div class="container mt-5">
        <div class="row align-items-center">
            ...
            <div class="carousel-item active">
                <img src="../productimg/Toran1.jpg" class="d-block w-100" alt="Toran View 1">
            </div>
            <div class="carousel-item">
                <img src="../productimg/Toran2.jpg" class="d-block w-100" alt="Toran View 2">
            </div>
                    </div>
            ...
            <div class="col-md-6">
                <h1 class="product-title">Toran</h1>
