...
<head>
    ...
    <title>CP Big Lining Fabric</title>
    ...
    <div class="container mt-5">
        <div class="row align-items-center">
            ...
            <div class="carousel-item active">
                <img src="../productimg/CPBigLining1.jpg" class="d-block w-100" alt="CPBigLining View 1">
            </div>
            <div class="carousel-item">
                <img src="../productimg/CPBigLining2.jpg" class="d-block w-100" alt="CPBigLining View 2">
            </div>
                    </div>
            ...
            <div class="col-md-6">
                <h1 class="product-title">CP Big Lining</h1>
