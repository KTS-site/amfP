...
<head>
    ...
    <title>Delta Lycra Fabric</title>
    ...
    <div class="container mt-5">
        <div class="row align-items-center">
            ...
            <div class="carousel-item active">
                <img src="../productimg/DeltaLycra1.jpg" class="d-block w-100" alt="DeltaLycra View 1">
            </div>
            <div class="carousel-item">
                <img src="../productimg/DeltaLycra2.jpg" class="d-block w-100" alt="DeltaLycra View 2">
            </div>
            <div class="carousel-item">
                <img src="../productimg/DeltaLycra3.jpg" class="d-block w-100" alt="DeltaLycra View 3">
            </div>
            <div class="carousel-item">
                <img src="../productimg/DeltaLycra4.jpg" class="d-block w-100" alt="DeltaLycra View 4">
            </div>
            <div class="carousel-item">
                <img src="../productimg/DeltaLycra5.jpg" class="d-block w-100" alt="DeltaLycra View 5">
            </div>
                    </div>
            ...
            <div class="col-md-6">
                <h1 class="product-title">Delta Lycra</h1>
                ...
                <div class="spec-item">
                    ...
                    <div class="spec-item">
                        ...
                        <span class="spec-value">73 Colours</span>
                    </div>
                    <div class="spec-item">
