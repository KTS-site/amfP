...
<head>
    ...
    <title>Ferido Butii Fabric</title>
    ...
    <div class="container mt-5">
        <div class="row align-items-center">
            ...
            <div class="carousel-item active">
                <img src="../productimg/FeridoButii1.jpg" class="d-block w-100" alt="FeridoButii View 1">
            </div>
                    </div>
            ...
            <div class="col-md-6">
                <h1 class="product-title">Ferido Butii</h1>
        ...
        <div class="row">
            <div class="col-md-4 mb-4">
                <img src="../productimg/Sample/Butti.jpg" class="img-fluid sample-image" alt="Sample Product 1">
            </div>
        </div>
    </div>
