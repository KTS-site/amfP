...
<head>
    ...
    <title>Double Checks Fabric</title>
    ...
    <div class="container mt-5">
        <div class="row align-items-center">
            ...
            <div class="carousel-item active">
                <img src="../productimg/DoubleChecks1.jpg" class="d-block w-100" alt="DoubleChecks View 1">
            </div>
                    </div>
            ...
            <div class="col-md-6">
                <h1 class="product-title">DoubleChecks</h1>
