    ...
    <div class="container mt-5">
        <div class="row align-items-center">
            ...
            <div class="carousel-item active">
                <img src="../productimg/CPLine1.jpg" class="d-block w-100" alt="CPLine View 1">
            </div>
            <div class="carousel-item">
                <img src="../productimg/CPLine2.jpg" class="d-block w-100" alt="CPLine View 2">
            </div>
                    </div>
            ...
            <div class="col-md-6">
                <h1 class="product-title">CP Line</h1>
